...
public class MethodParser extends Parser<Method> {
	...
	public boolean shouldParse(String line) {
		return line
				.matches("method [a-zA-Z][a-zA-Z0-9]* requires \\(([a-zA-Z][a-zA-Z0-9]* [a-zA-Z][a-zA-Z0-9]*)*\\) returns [a-zA-Z][a-zA-Z0-9]*");
	}
	...
	public Method parse(Block superBlock, Tokenizer tokenizer) {
		...
		if (!first.getToken().equals(")")) {
			...
			while (tokenizer.hasNextToken()) {
				...
				if (paramData[0] == null) {
					...
					params.add(new Parameter(Type.valueOf(paramData[0]
		...
		Type returnType = Type.valueOf(tokenizer.nextToken().getToken()
				.toUpperCase());

		return new Method(superBlock, name, returnType,
